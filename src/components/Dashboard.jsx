...
const Table = ({ headers, rows, accent = '#4ade80' }) => (
        ...
        {tabs.map(t => (
          <button
            ...
            style={{
              ...
              background: tab === t.id ? '#4ade80' : 'rgba(255,255,255,0.06)',
      ...
      {tab === 'enemies' && (
        <Card accent="#f87171">
          ...
          <Table
            ...
            rows={ENEMIES.map(e => [
              <span style={{ fontFamily: 'monospace', color: '#f87171', fontWeight: '700' }}>Score {e.at}</span>,
          ...
          />
          <div style={{ marginTop: '14px', padding: '10px 14px', background: 'rgba(248,113,113,0.08)', borderRadius: '8px', fontSize: '12px', color: '#f87171', borderLeft: '3px solid #f87171' }}>
